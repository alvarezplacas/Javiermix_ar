...
export const artworks = pgTable('artworks', {
    ...
    is_limited_edition: integer('is_limited_edition').default(0), // 0: no, 1: yes
    edition_total: integer('edition_total').default(0), // max copies available
    certificate_included: integer('certificate_included').default(1), // 1: authentic certificate
...
export const magazine = pgTable('magazine', {
    ...
    is_premium: integer('is_premium').default(0), // 1: only for collectors
