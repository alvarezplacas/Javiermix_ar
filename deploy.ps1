...
ssh root@144.217.163.13 "cd /home/ubuntu/javiermix_web ; git pull origin main ; docker compose -f vps_extras/docker-compose.prod.yml up -d --build web_javiermix"
